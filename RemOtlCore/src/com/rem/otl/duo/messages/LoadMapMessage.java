...
/**
 * Similar to the purpose of the {@link com.rem.otl.duo.messages.SendMapMessage} the LoadMapMessage is sent by the "Joined" {@link com.rem.otl.duo.client.Client}.
 * This is needed because the Joined client is not required to have the map data, only the host needs to have maps.
 * However if the Joined client recognizes that she has stepped on a square which requires the changing of {@link com.rem.otl.core.game.environment.Map}s then a new map has to be sent to the joined {@link com.rem.otl.duo.client.Client}.
 ...
 * @see com.rem.otl.duo.messages.SendMapMessage
 * @author Geoffrey
 *
 */
public class LoadMapMessage extends Message{
	...
	/**
	 * Initializes the two variables to be sent with this {@link com.rem.otl.duo.messages.Message}: The filename of the map, and the {@link com.rem.otl.duo.messages.Message} to be acted upon after the map has been sent.
	 ...
	 * @param onEnd - To avoid any discontinuity, there is an associated "onEnd" {@link com.rem.otl.duo.messages.Message} which is acted upon after this {@link com.rem.otl.duo.messages.Message} has been received.
	 */
	...
	/**
	 * Sends the new map's data using the {@link com.rem.otl.duo.messages.SendMapMessage}'s send method, as well as calls the onEnd {@link com.rem.otl.duo.messages.Message}'s act function.
	 * @param handler - The handler of this {@link com.rem.otl.duo.client.Client}, used as a starting point for calling functions deeper in the game. 
	 */
	@Override
