...
/**
 * This class wraps the a {@link com.rem.otl.core.gui.graphics.GraphicEntity} object with an {@link com.rem.otl.game.Action} which is used by an {@link com.rem.otl.editor.Editor}.
...
public class Button extends GraphicEntity{
	...
	/**
	 * Buttons cannot be visually turned on by their parent {@link com.rem.otl.game.environment.Square}.
	 */
	@Override
	public void turnOn(){		
	}
	/**
	 * Buttons cannot be visually turned off by their parent {@link com.rem.otl.game.environment.Square}.
	 */
	@Override
	public void turnOff(){		
	}
