...
import com.rem.otl.duo.messages.ChatMessage;
import com.rem.otl.editor.TextWriter;
import com.rem.otl.game.hero.Hero;
import com.rem.core.gui.inputs.ClickEvent;

public class Chat extends GraphicEntity implements KeyBoardListener, Acceptor {
	...
	public Chat(int layer, boolean myColour) {
		...
		chatButton = new com.rem.core.gui.graphics.MenuButton(""){
	...
	public void accept(String command, Object object) {
		if("addEntry".equals(command)){
			logChat((ChatLogEntry) object);
		}
	}
}
