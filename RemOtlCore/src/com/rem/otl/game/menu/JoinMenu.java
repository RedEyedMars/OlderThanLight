...
import com.rem.otl.duo.messages.JoinGameMessage;
...
public class JoinMenu extends Menu implements IDuoMenu{
	...
	private GameListAcceptor gamesList;
	...
	public JoinMenu() {
		...
		addChild(buttonList);
		gamesList = new GameListAcceptor(buttonList);
