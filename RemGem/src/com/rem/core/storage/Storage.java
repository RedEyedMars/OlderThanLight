...
public class Storage {
	...
	public static void loadMap(String name,String filename, byte[] file){
		...
		DataIterator iterator = new DataIterator(loaded);
		Hub.map = Hub.creator.createPlaceHolderEnvironment();
		Hub.map.setNameAndFileName(name,filename);
		Hub.map.getLoader().load(iterator.getIntegers(),iterator.getFloats(),iterator.getStrings());
	}
	...
	public static void saveMap(Resource<OutputStream> resource, Environment map) {
