...
public class PCGraphicLine extends GraphicElement{
	public PCGraphicLine(String textureName, GraphicView view) {
	...
	protected void draw(){
		...
		for(int i = 1; i <= GraphicLine.SEGMENT_COUNT; i++)
		{
			float t = i / (float) GraphicLine.SEGMENT_COUNT;
